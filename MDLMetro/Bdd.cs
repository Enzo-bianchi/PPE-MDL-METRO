...
namespace BaseDeDonnees
{
    class Bdd
    {
        ...
        /// <summary>
        /// Procédure permettant d'ajouter les thèmes dans les ateliers
        /// </summary>
        /// <param name="PidAtelier">Correspond à l'id de l'atelier</param>
        /// <param name="PlibelleTheme">Correspond au libelle de l'atelier</param>
        public void AjoutTheme(int PidAtelier, string PlibelleTheme)
        {
            try
            {
        ...
        /// <summary>
        /// Procédure permettant l'ajout de vacation
        /// </summary>
        /// <param name="PidAtelier">Correspond à l'id de l'atelier</param>
        ...
        /// <summary>
        /// Procédure permettant d'ajouter un atelier
        /// </summary>
        /// <param name="LibelleAtelier">Correspond au libelle de l'atelier</param>
        /// <param name="PnbPlaceMaxi">Correspond au nombre maxi de place dans l'atelier</param>
        /// <param name="pLibelleTheme">Correspond au libelle du theme</param>
        /// <param name="pVacationsHeureDebut">Correspond à l'heure de début de l'atelier</param>
        /// <param name="pVacationsHeureFin">Correspond à l'heure de fin de l'atelier</param>
        public void AjoutAtelier(string LibelleAtelier, int PnbPlaceMaxi, Collection<string> pLibelleTheme, Collection<string> pVacationsHeureDebut, Collection<string> pVacationsHeureFin)
        {
            try
            {
                UneOracleCommand = new OracleCommand("pckatelier.creerAtelier", CnOracle);
                UneOracleCommand.CommandType = CommandType.StoredProcedure;
                UneOracleCommand.Parameters.Add("plibelleatelier", OracleDbType.Varchar2, ParameterDirection.Input).Value = LibelleAtelier;
                UneOracleCommand.Parameters.Add("pnbplacesmaxi", OracleDbType.Int32, ParameterDirection.Input).Value = PnbPlaceMaxi;

                OracleParameter pLesLibelles = new OracleParameter();
                pLesLibelles.ParameterName = "plesthemes";
                pLesLibelles.OracleDbType = OracleDbType.Varchar2;
                pLesLibelles.CollectionType = OracleCollectionType.PLSQLAssociativeArray;
                pLesLibelles.Value = pLibelleTheme.ToArray();
                pLesLibelles.Size = pLibelleTheme.Count;
                UneOracleCommand.Parameters.Add(pLesLibelles);

                OracleParameter pLesDatesDebut = new OracleParameter();
                pLesDatesDebut.ParameterName = "plesvacationsdebut";
                ...
                pLesDatesFin.ParameterName = "plesvacationsfin";
        ...
        /// <param name="pIdAtelier">Correspond à l'id de l'atelier</param>
        public void ModificationVacation(Collection<string> pVacationsHeureDebut, Collection<string> pVacationsHeureFin, int pIdAtelier)
        {
            try
            {
                ...
                OracleParameter pLesDatesFin = new OracleParameter();
                pLesDatesFin.ParameterName = "plesdatesfin";
                pLesDatesFin.OracleDbType = OracleDbType.Varchar2;
                pLesDatesFin.CollectionType = OracleCollectionType.PLSQLAssociativeArray;
                pLesDatesFin.Value = pVacationsHeureFin.ToArray();
                pLesDatesFin.Size = pVacationsHeureFin.Count;
